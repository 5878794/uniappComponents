...
{
  //获取图片信息  宽高等
  getImageInfo: function getImageInfo(src) {var _this = this;
    return new Promise( /*#__PURE__*/function () {var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(_success, error) {return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:if (!(
                src.indexOf('http') == 0 || src.indexOf('https') == 0)) {_context.next = 4;break;}_context.next = 3;return (
                  _this.downloadImg(src));case 3:src = _context.sent;case 4:
  ...
  downloadImg: function downloadImg(url) {
    return new Promise(function (_success2, error) {
      uni.downloadFile({
  ...
  //画布转图片路径
  canvasToTempFile: function canvasToTempFile(canvasId, components) {
  ...
  //保存到相册
  saveImgToAlbum: function saveImgToAlbum(src) {return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:_context2.next = 2;return (
                (0, _authorize.default)('writePhotosAlbum'));case 2:return _context2.abrupt("return",

              new Promise(function (_success4, _error) {
